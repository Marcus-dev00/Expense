...
const translations = {
    en: {
        ...
        "shots.desc": "Real screenshots coming soon. These slots will be replaced with actual app captures.",
        "shots.s1": "Home · today's spend",
        "shots.s2": "Inbox · auto-captured",
        "shots.s3": "Stats · month & categories",
        "shots.s4": "Accounts · cash & cards",
    ...
    zh: {
        ...
        "shots.tag": "界面一览",
        "shots.title": "应用长什么样",
        "shots.desc": "真实截图即将放上。先看示意位置，正式版会替换。",
        "shots.s1": "首页 · 今天花了多少",
        "shots.s2": "待确认 · 自动捕获的账",
        "shots.s3": "统计 · 月度与分类",
        "shots.s4": "账户 · 现金与银行卡",
    ...
    ms: {
        ...
        "hero.btnBeta": "Sertai beta tertutup",
        ...
        "shots.tag": "Skrin",
        "shots.title": "Rupa aplikasi",
        "shots.desc": "Tangkapan skrin sebenar akan datang. Slot ini akan diganti dengan gambar sebenar.",
        "shots.s1": "Utama · belanja hari ini",
        "shots.s2": "Inbox · auto tangkap",
        "shots.s3": "Statistik · bulan & kategori",
        "shots.s4": "Akaun · tunai & kad",
